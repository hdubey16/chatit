...
export function derivePastePreview(content: string) {
    ...
    <Dialog open={open} onOpenChange={(next) => !next && onClose()}>
      {active && (
        <DialogContent
          ...
          // @ts-expect-error onOpenAutoFocus is a valid Radix primitive prop but may be missing from the local DialogContent types
